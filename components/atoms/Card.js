      ...
      <AnimatePresence initial={false} custom={direction}>
        ...
        >
          ...
          <div className="m-2 flex justify-center items-center flex-col">
            <p className="text-xl text-black bottom-5 m-1">{Projects[imageIndex].title}</p>
        ...
        <div className="flex justify-center items-center absolute z-20 bottom-56 md:bottom-36 ">
          <FaArrowLeft className="animate-bounce cursor-pointer" onClick={() => paginate(1)} />
          <p className="m-2">swipe</p>
          <FaArrowRight className="animate-bounce cursor-pointer" onClick={() => paginate(-1)} />
        </div>
      </AnimatePresence>
    </>
  );
