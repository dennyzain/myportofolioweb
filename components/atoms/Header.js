      ...
      {state.isOpen ? (
        ...
        <div>
          ...
          <div className="bottom-0 grid grid-cols-6 grid-rows-2 gap-2 mb-3 text-xl w-full z-40 fixed animate-colorGradient">
            <a className="row-span-2 col-start-1 self-center justify-self-center" href="http://">
              <FaFacebookF />
            </a>
            <a className="row-span-2 col-start-2 self-center justify-self-center" href="http://">
              <FaInstagram />
            </a>
            <a className="row-span-2 col-start-3 self-center justify-self-center" href="http://">
              <FaGithub />
            </a>
            <a
